...
export const faqs: FaqItem[] = [
  {
    ...
    answer:
      'RflowZ is an AI-powered research proposal platform for students, academics, and research teams. Use Ask Prof Z to draft proposal sections, search OpenAlex and policy/media sources in your Library, synthesize literature with RAG, and export to DOCX, PDF, or PPTX with citation integrity checks.',
  },
  {
    question: 'How does the Source Library and OpenAlex search work?',
    answer:
      'Search academic papers via OpenAlex and add policy or media sources in your Library. Attach verified sources to literature sub-topics, then Ask Prof Z synthesizes from those sources using RAG so citations stay tied to what you selected.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'RflowZ is built for structured research proposals: section workflows, OpenAlex Library search, RAG with Ask Prof Z, citation integrity checks before export, and DOCX/PDF/PPTX output. General chat tools do not provide that end-to-end proposal pipeline.',
  },
  {
    question: 'What is RAG on RflowZ?',
    answer:
      'RAG (retrieval-augmented generation) uses sources you attach from your Library when Ask Prof Z writes. On Free, RAG is limited to 10 documents per month; paid plans include unlimited RAG. Citation integrity checks help catch unresolved or mismatched references before you export.',
  },
  {
    question: 'What paid plans are available?',
    answer:
      'Starter is the live paid plan at $3.99 per month. Standard ($4.99) and Professional ($7.99) are listed as coming soon. Those monthly USD rates match the Yearly view of in-app plans at app.rflowz.com/subscription (August 2026). Choose monthly or annual billing in the app; this site does not promise a cheaper annual package.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'You land in the RflowZ app on the Free plan — no credit card. Start a proposal with Ask Prof Z onboarding (language and research type), then use the Library, RAG, and citation checks. You can stay on Free or upgrade to Starter from inside the app.',
  },
  {
